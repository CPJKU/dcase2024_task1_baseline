...
if __name__ == '__main__':
    ...
    parser.add_argument('--experiment_name', type=str, default="DCASE24_KD_Base2HalfBase_Ali1_sub5_no_lmda_cosine_sch_best")
    ...
    # parser.add_argument('--kd_lambda', type=float, default=0.1) # default is 0.02
