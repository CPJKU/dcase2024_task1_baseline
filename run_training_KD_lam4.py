...
if __name__ == '__main__':
    ...
    parser.add_argument('--experiment_name', type=str, default="DCASE24_KD_Ensemble2Base_Ali1_sub5_lmda_cosine_sch_LR_0009")
    ...
    parser.add_argument('--lr', type=float, default=0.0009) # can try 0.001, was 0.005
