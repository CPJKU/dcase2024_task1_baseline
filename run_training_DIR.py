...
def train(config):
    ...
    train_dl = DataLoader(dataset=get_training_set(config.subset, roll=roll_samples, resample_rate = config.sample_rate),
...
if __name__ == '__main__':
    ...
    parser.add_argument('--experiment_name', type=str, default="Baseline_DSP1_sub5_441K_augmented")
