...
if __name__ == '__main__':
    ...
    parser.add_argument('--experiment_name', type=str, default="Baseline_DSP1_sub5_warmup_scaled")
    ...
    # preprocessing
    parser.add_argument('--sample_rate', type=int, default=32000) # default = 320000, want to use 44100
