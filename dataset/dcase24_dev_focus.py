...
dataset_config = {
    ...
    "logits_file": os.path.join("predictions","evm9n2mt", "logits.pt") #specifies where the logit and predictions are stored. Still need to provide script with ckpt_id
